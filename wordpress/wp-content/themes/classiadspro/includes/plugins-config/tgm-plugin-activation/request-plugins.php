...
do_action('pacz_templates_compatibility_check', '1.7.4');
...
function pacz_classiadspro_register_required_plugins() {
	...
	$dynamic_url = 'https://assets.designinvento.net/plugins/classiadspro/6.2/';
    $plugins = array(
        array(
            'name' => 'Classiads Templates',
            'slug' => 'classiads-templates',
            'source' => get_template_directory() . '/plugins/classiads-templates.zip',
            'required' => true,
            'version' => '1.7.4',
