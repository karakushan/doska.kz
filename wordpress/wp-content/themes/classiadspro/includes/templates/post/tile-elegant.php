<?php
	...
	$atts['category_meta'] = false;
	$atts['date_meta'] = true;
	$atts['author_meta'] = true;
	...
	echo '<div class="'. $col .'">';
		echo '<article id="pacz-post-entry-' . get_the_ID() . '" class="pacz-post-tile-elegant '. $sticky . $thumbnail_class .' pacz-post-format-'. $post_type .'">';
