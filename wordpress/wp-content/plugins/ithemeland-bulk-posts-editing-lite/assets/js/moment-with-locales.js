!(function (e, a) {
        ...
        if (!e._d) {
            ...
            for (
                _ = e,
                    ...
                    null != e._dayOfYear &&
                        ((d = la(e._a[he], s[he])), (e._dayOfYear > Te(d) || 0 === e._dayOfYear) && (Y(e)._overflowDayOfYear = !0), (t = Je(d, 0, e._dayOfYear)), (e._a[Le] = t.getUTCMonth()), (e._a[ce] = t.getUTCDate())),
                    a = 0;
                a < 3 && null == e._a[a];
                ++a
            )
        ...
        if (e._f !== l.ISO_8601)
            if (e._f !== l.RFC_2822) {
                ...
                for (s = U(e._f, e._locale).match(z) || [], a = 0; a < s.length; a++)
                    (n = s[a]),
                        (t = (o.match(oe(n, e)) || [])[0]) && (0 < (d = o.substr(0, o.indexOf(t))).length && Y(e).unusedInput.push(d), (o = o.slice(o.indexOf(t) + t.length)), (u += t.length)),
                        R[n] ? (t ? (Y(e).empty = !1) : Y(e).unusedTokens.push(n), (r = n), (i = e), null != (_ = t) && h(ue, r) && ue[r](_, i._a, i, r)) : e._strict && !t && Y(e).unusedTokens.push(n);
                ...
                : ("string" == typeof d && (e._i = d = e._locale.preparse(d)),
                  D(d)
                      ...
                      : (u(d)
                            ...
                            : "string" == typeof t
                            ? ((s = a), null === (n = fa.exec(s._i)) ? (ka(s), !1 === s._isValid && (delete s._isValid, ga(s), !1 === s._isValid && (delete s._isValid, l.createFromInputFallback(s)))) : (s._d = new Date(+n[1])))
                            : _(t)
    ...
    function Ka(s, n) {
        return function (e, a) {
            ...
            return (
                null === a ||
                    isNaN(+a) ||
                    (S(n, "moment()." + n + "(period, number) is deprecated. Please use moment()." + n + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), (t = e), (e = a), (a = t)),
    ...
    (Mt.add = $a),
        ...
        (Mt.from = function (e, a) {
            return this.isValid() && ((D(e) && e.isValid()) || Ha(e).isValid()) ? Ua({ to: this, from: e }).locale(this.locale()).humanize(!a) : this.localeData().invalidDate();
        }),
        (Mt.fromNow = function (e) {
            return this.from(Ha(), e);
        }),
        (Mt.to = function (e, a) {
            return this.isValid() && ((D(e) && e.isValid()) || Ha(e).isValid()) ? Ua({ from: this, to: e }).locale(this.locale()).humanize(!a) : this.localeData().invalidDate();
        }),
        (Mt.toNow = function (e) {
            return this.to(Ha(), e);
        }),
        ...
        (Mt.utcOffset = function (e, a, t) {
            ...
            return (
                ...
                (this._isUTC = !0),
                null != s && this.add(s, "m"),
                n !== e && (!a || this._changeInProgress ? Za(this, Ua(e - n, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), l.updateOffset(this, !0), (this._changeInProgress = null))),
                this
            );
        }),
        (Mt.utc = function (e) {
    ...
    (Lt.calendar = function (e, a, t) {
        ...
        (Lt.monthsShortRegex = function (e) {
            return this._monthsParseExact
                ...
                : (h(this, "_monthsShortRegex") || (this._monthsShortRegex = Ee), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
        }),
        (Lt.week = function (e) {
        ...
        (Lt.weekdaysShortRegex = function (e) {
            return this._weekdaysParseExact
                ...
                : (h(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $e), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
        }),
        (Lt.weekdaysMinRegex = function (e) {
            return this._weekdaysParseExact
                ? (h(this, "_weekdaysRegex") || qe.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
                : (h(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Be), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
        }),
        (Lt.isPM = function (e) {
    ...
    l.defineLocale("ar-ly", {
        ...
        relativeTime: { future: "\u0628\u0639\u062f %s", past: "\u0645\u0646\u0630 %s", s: qt("s"), ss: qt("s"), m: qt("m"), mm: qt("m"), h: qt("h"), hh: qt("h"), d: qt("d"), dd: qt("d"), M: qt("M"), MM: qt("M"), y: qt("y"), yy: qt("y") },
        preparse: function (e) {
            return e.replace(/\u060c/g, ",");
        },
    ...
    function Ms(e, a, t) {
        var s, n, d;
        return e + " " + ((s = { mm: "munutenn", MM: "miz", dd: "devezh" }[t]), 2 !== e ? s : void 0 !== (d = { m: "v", b: "v", d: "z" })[(n = s).charAt(0)] ? d[n.charAt(0)] + n.substring(1) : n);
    }
    function hs(e, a, t) {
        var s = e + " ";
        switch (t) {
    ...
    l.defineLocale("cs", {
        ...
        l.defineLocale("de-at", {
            ...
            relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", ss: "%d Sekunden", m: ps, mm: "%d Minuten", h: ps, hh: "%d Stunden", d: ps, dd: ps, M: ps, MM: ps, y: ps, yy: ps },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: "%d.",
            week: { dow: 1, doy: 4 },
        }),
        l.defineLocale("de-ch", {
            ...
            longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D. MMMM YYYY", LLL: "D. MMMM YYYY HH:mm", LLLL: "dddd, D. MMMM YYYY HH:mm" },
            calendar: { sameDay: "[heute um] LT [Uhr]", sameElse: "L", nextDay: "[morgen um] LT [Uhr]", nextWeek: "dddd [um] LT [Uhr]", lastDay: "[gestern um] LT [Uhr]", lastWeek: "[letzten] dddd [um] LT [Uhr]" },
            relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", ss: "%d Sekunden", m: Ds, mm: "%d Minuten", h: Ds, hh: "%d Stunden", d: Ds, dd: Ds, M: Ds, MM: Ds, y: Ds, yy: Ds },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: "%d.",
            week: { dow: 1, doy: 4 },
        }),
        l.defineLocale("de", {
            ...
            longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D. MMMM YYYY", LLL: "D. MMMM YYYY HH:mm", LLLL: "dddd, D. MMMM YYYY HH:mm" },
            calendar: { sameDay: "[heute um] LT [Uhr]", sameElse: "L", nextDay: "[morgen um] LT [Uhr]", nextWeek: "dddd [um] LT [Uhr]", lastDay: "[gestern um] LT [Uhr]", lastWeek: "[letzten] dddd [um] LT [Uhr]" },
            relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", ss: "%d Sekunden", m: Ts, mm: "%d Minuten", h: Ts, hh: "%d Stunden", d: Ts, dd: Ts, M: Ts, MM: Ts, y: Ts, yy: Ts },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: "%d.",
            week: { dow: 1, doy: 4 },
        });
    ...
    l.defineLocale("es", {
        ...
        l.defineLocale("et", {
            ...
            relativeTime: { future: "%s p\xe4rast", past: "%s tagasi", s: zs, ss: zs, m: zs, mm: zs, h: zs, hh: zs, d: zs, dd: "%d p\xe4eva", M: zs, MM: zs, y: zs, yy: zs },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: "%d.",
            week: { dow: 1, doy: 4 },
        }),
    ...
    l.defineLocale("ga", {
        ...
        longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD/MM/YYYY", LL: "D MMMM YYYY", LLL: "D MMMM YYYY HH:mm", LLLL: "dddd, D MMMM YYYY HH:mm" },
        calendar: { sameDay: "[Inniu ag] LT", nextDay: "[Am\xe1rach ag] LT", nextWeek: "dddd [ag] LT", lastDay: "[Inn\xe9 aig] LT", lastWeek: "dddd [seo caite] [ag] LT", sameElse: "L" },
        relativeTime: {
            future: "i %s",
            past: "%s \xf3 shin",
            s: "c\xfapla soicind",
    ...
    l.defineLocale("hu", {
        ...
        l.defineLocale("is", {
            ...
            relativeTime: { future: "eftir %s", past: "fyrir %s s\xed\xf0an", s: tn, ss: tn, m: tn, mm: tn, h: "klukkustund", hh: tn, d: tn, dd: tn, M: tn, MM: tn, y: tn, yy: tn },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: "%d.",
            week: { dow: 1, doy: 4 },
        }),
    ...
    l.defineLocale("mr", {
        ...
        relativeTime: { future: "%s\u092e\u0927\u094d\u092f\u0947", past: "%s\u092a\u0942\u0930\u094d\u0935\u0940", s: Hn, ss: Hn, m: Hn, mm: Hn, h: Hn, hh: Hn, d: Hn, dd: Hn, M: Hn, MM: Hn, y: Hn, yy: Hn },
        preparse: function (e) {
            return e.replace(/[\u0967\u0968\u0969\u096a\u096b\u096c\u096d\u096e\u096f\u0966]/g, function (e) {
                return Sn[e];
            });
    ...
    function Kn(e, a, t) {
        var s = " ";
        return (20 <= e % 100 || (100 <= e && e % 100 == 0)) && (s = " de "), e + s + { ss: "secunde", mm: "minute", hh: "ore", dd: "zile", MM: "luni", yy: "ani" }[t];
    }
    function Zn(e, a, t) {
        var s, n;
        return "m" === t
    ...
    l.defineLocale("pl", {
        ...
        l.defineLocale("ro", {
            ...
            relativeTime: { future: "peste %s", past: "%s \xeen urm\u0103", s: "c\xe2teva secunde", ss: Kn, m: "un minut", mm: Kn, h: "o or\u0103", hh: Kn, d: "o zi", dd: Kn, M: "o lun\u0103", MM: Kn, y: "un an", yy: Kn },
            week: { dow: 1, doy: 7 },
        });
    var $n = [
        /^\u044f\u043d\u0432/i,
