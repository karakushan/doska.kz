					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="panel-Service-box blue">
							...
							<div class="panel-service-content">
								...
								<a href="https://help.designinvento.net/support" target="_blank"><?php echo esc_html__('Support Desk', 'DIRECTORYPRESS'); ?></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="panel-Service-box pink">
							...
							<div class="panel-service-content">
								...
								<a href="https://help.designinvento.net/suggestions" target="_blank"><?php echo esc_html__('Feature Suggestions', 'DIRECTORYPRESS'); ?></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 mt-30">
						<a href="https://designinvento.net/themes/" target="_blank"><img src="<?php echo esc_url(DIRECTORYPRESS_URL .'admin/assets/images/themes.png'); ?>" alt="premium themes" /></a>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 mt-30">
						<a href="https://designinvento.net/directorypress-extentions/" target="_blank"><img src="<?php echo esc_url(DIRECTORYPRESS_URL .'admin/assets/images/extensions.png'); ?>" alt="premium extensions" /></a>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 mt-30">
