<?php if ($field->value && isset($field->selection_items[$field->value])):
	...
	$field_value = $field->selection_items[$field->value];
	if (function_exists('classiadspro_translatepress_translate_listing_string')) {
		$field_value = classiadspro_translatepress_translate_listing_string($field_value, false);
	}
?>
