jQuery(function ($) {
    // Constants
    const SELECTORS = {
      termsLink: ".tpap-see-terms",
      termsBox: "#termsBox",
      refreshBtn: ".tpap-refresh-btn",
      licenseContainer: ".tpap-dashboard-license-pro-container",
      deactivateBtn: ".tpap-dashboard-license-pro-container-deactivate-btn",
      validityStrong: ".validity:has(strong) strong",
      validitySpan: ".validity:not(:has(strong))",
      licenseType: ".license-type",
      containerUl: ".tpap-dashboard-license-pro-container ul",
      errorNotice: ".tpap-dashboard-license-pro-container div.notice.notice-error",
    };
    ...
    const URLS = {
      renewLink: "https://my.example.net/account/subscriptions/"
    };
    ...
    $refreshBtn.on("click", function (e) {
      ...
      // AJAX request
      $.ajax({
        url: tpap_ajax.ajaxurl,
        type: "POST",
        data: {
          action: "tpap_refresh_license_ajax",
          nonce: tpap_ajax.nonce,
        },
