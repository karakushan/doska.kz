...
/**
 * Plugin Name:       ElKit ( Elementor Addons Kit )
 * Plugin URI:        https://designinvento.net/downloads/elkit/
...
define( 'ELKIT_VERSION', '1.0.7' );
define('ELKIT_PATH', plugin_dir_path(__FILE__));
define('ELKIT_URL', plugins_url('/', __FILE__));
define('ELKIT_RESOURCES_PATH', ELKIT_PATH . 'assets/');
define('ELKIT_RESOURCES_URL', ELKIT_URL . 'assets/');
define( 'ELKIT_TEMPLATES_PATH', ELKIT_PATH . 'public/');

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/class-elkit-activator.php
 */
function activate_elkit() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-elkit-activator.php';
	Elkit_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-elkit-deactivator.php
 */
function deactivate_elkit() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-elkit-deactivator.php';
	Elkit_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'activate_elkit' );
register_deactivation_hook( __FILE__, 'deactivate_elkit' );

/**
 * The core plugin class that is used to define internationalization,
 * admin-specific hooks, and public-facing site hooks.
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-elkit.php';
