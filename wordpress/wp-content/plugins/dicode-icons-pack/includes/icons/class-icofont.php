...
/*--------------------------
*   Class Icofont  Icon Manager
* -------------------------*/
class Dicode_Icons_Icofont_Icons{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_icofont'] = array(
	        'name'          => 'dicode_icons_icofont',
	        'label'         => esc_html__( 'Dicode - Icofont', 'dicode-icons-pack' ),
	        'labelIcon'     => 'icofont-brand-icofont',
	        'prefix'        => 'icofont-',
	        'displayPrefix' => '',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'icofont/icofont.min.css',
...
Dicode_Icons_Icofont_Icons::init();