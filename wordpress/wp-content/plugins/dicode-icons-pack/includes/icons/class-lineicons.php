...
class Dicode_Icons_Lineicons{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_lineicons'] = array(
	        'name'          => 'dicode_icons_-line-icon',
	        'label'         => esc_html__( 'Dicode - Lineicons', 'dicode-icons-pack' ),
	        'labelIcon'     => 'lni lni-lineicons',
	        'prefix'        => 'lni-',
	        'displayPrefix' => 'lni',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'lineicons/lineicons.min.css',
