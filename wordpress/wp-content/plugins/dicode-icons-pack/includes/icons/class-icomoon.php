...
class Dicode_Icons_Icomoon{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_icomoon'] = array(
	        'name'          => 'dicode_icons_icomoon',
	        'label'         => esc_html__( 'Dicode - Icomoon', 'dicode-icons-pack' ),
	        'labelIcon'     => 'icomoon icomoon-IcoMoon',
	        'prefix'        => 'icomoon-',
	        'displayPrefix' => 'icomoon',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'icomoon/icomoon.min.css',
