...
class Dicode_Icons_Themify{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_themify'] = array(
	        'name'          => 'dicode_icons_-themify-icon',
	        'label'         => esc_html__( 'Dicode - Themify Icons', 'dicode-icons-pack' ),
	        'labelIcon'     => 'fas fa-user',
	        'prefix'        => '',
	        'displayPrefix' => '',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'themify/themify.min.css',
