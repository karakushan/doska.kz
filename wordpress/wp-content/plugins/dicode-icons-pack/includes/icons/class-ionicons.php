...
class Dicode_Icons_Ionicons{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_ionicon'] = array(
	        'name'          => 'dicode_icons_-ion-icon',
	        'label'         => esc_html__( 'Dicode - Ionicons', 'dicode-icons-pack' ),
	        'labelIcon'     => 'ion-logo-ionic',
	        'prefix'        => 'ion-',
	        'displayPrefix' => '',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'ionicons/ionicons.min.css',
