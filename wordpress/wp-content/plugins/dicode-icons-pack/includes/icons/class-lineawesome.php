...
class Dicode_Icons_Line_Awesome{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_lineawesome'] = array(
	        'name'          => 'dicode_icons_-lineawesome-icon',
	        'label'         => esc_html__( 'Dicode - Line Awesome', 'dicode-icons-pack' ),
	        'labelIcon'     => 'fas fa-user',
	        'prefix'        => '',
	        'displayPrefix' => '',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'line-awesome/line-awesome.min.css',
...
Dicode_Icons_Line_Awesome::init();