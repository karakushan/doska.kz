...
class Dicode_Icons_Material_Design{
	...
	public static function el_icons_args( $tabs = array() ) {
	    ...
	    $tabs['dicode_icons_md'] = array(
	        'name'          => 'dicode_icons_-materialdesign-icon',
	        'label'         => esc_html__( 'Dicode - Material Icons', 'dicode-icons-pack' ),
	        'labelIcon'     => 'dicode-material-icons dicode-material-icons-material-design',
	        'prefix'        => 'dicode-material-icons-',
	        'displayPrefix' => 'dicode-material-icons',
	        'url'           => DICODE_ICONS_ASSETS_URL . 'material/material-icons.min.css',
...
Dicode_Icons_Material_Design::init();