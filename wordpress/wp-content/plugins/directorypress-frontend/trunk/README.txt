...
This plugin provides frontend listing functionality for [DirectoryPress - Directory Listing Plugin](https://designinvento.net/downloads/directorypress-wordpress-directory-plugin/ "Directory Listing Plugin").

== Description ==

Plugin offer frontend listing submission, with extensive user control panel, author of the listing can manage their listing, edit listing, delete listing and many other features like upgrade, renewal, bump up/raise up option, further user can control their profile and their purchases.
...
* [DirectoryPress - Directory Listing Plugin](https://designinvento.net/downloads/directorypress-wordpress-directory-plugin/ "Directory Listing Plugin")
...
1. Plugin required DirectorPress Plugin. Make sure you have already installed it by downloading from https://designinvento.net/downloads/directorypress-wordpress-directory-plugin/
2. Upload the plugin files to the `/wp-content/plugins/directorypress-frontend` directory, or install the plugin through the WordPress plugins screen directly.
...
=2.8.2=
* DirectoryPress 3.6.22 compatibility.
* security improvements.
...
* minor fixes
=2.8.0=
* Directorypress 3.6.21 compatibility
...
* minor fixes
=2.7.8=
* Directorypress 3.6.15 compatibility
* security audit to eliminate reported vulnerability.
* translations updated.
* minor fixes

=2.7.8=
* Directorypress 3.6.12 compatibility
* php 8.2 compatibility added.
* minor fixes

=2.7.7=
* Directorypress 3.6.9 compatibility
* user dashboard mobile issue resolved.
* translations updated
* minor fixes
=2.7.6=
* Directorypress 3.6.8 compatibility
* bootstrap 5.3.2 compatibility
* translations updated
* minor fixes
=2.7.5=
* Directorypress 3.6.6 compatibility
* translations updated
* minor fixes

=2.7.4=
* Directorypress 3.6.5 compatibility
* translations updated
* minor fixes
...
=2.7.0=
* complete redesigned user dashboard.
* packages count issue resolved!
* add listing form redesigned.
* translations updated
* minor fixes
=2.6.7=
* Elementor's deprecated method changed.
* translations updated
* minor fixes

=2.6.6=
* New elementor widget added for pricing plans
* translations updated
* minor fixes

=2.6.5=
* Address field added in front-end user panel > account > edit profile 
* Biography field added in front-end user panel > account > edit profile