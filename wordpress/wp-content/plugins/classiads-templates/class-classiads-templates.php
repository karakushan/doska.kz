...
class Classiads_Templates {
	...
	public function __construct( $config = array(), $strings = array() ) {
		...
		if(!get_option( 'designinvento_templates_classiadspro_completed') || empty(get_option( 'designinvento_templates_classiadspro_completed'))){
	...
	function verify_envato_purchase_code($purchse_code, $token) {
		...
		if($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'classiads.designinvento.net')
			return true;
	...
	public function designinvento_templates_steps() {
		...
		$this->steps['child'] = array(
			'name'    => esc_html__( 'Install classiadsPro Child Theme', 'designinvento-templates' ),
	...
	public function designinvento_templates_after_content_import_setup( $selected_import_index ) {
		...
		if($selected_import_index == 0){
			...
			include DT_PATH .'demos/elementor/classiads-moto/terms.php';
		}elseif($selected_import_index == 12){
			include DT_PATH .'demos/elementor/classiads-phone/terms.php';
		...
		}elseif($selected_import_index == 21){
			include DT_PATH .'demos/elementor/classiads-realestate/terms.php';
		}else{
	...
	public function designinvento_templates_before_content_import_setup($selected_import_index) {
		...
		if($selected_import_index == 0){
			...
			include DT_PATH .'demos/elementor/classiads-moto/terms.php';
			include DT_PATH .'demos/elementor/classiads-moto/custom-tables.php';
		}elseif($selected_import_index == 12){
			include DT_PATH .'demos/elementor/classiads-phone/terms.php';
			include DT_PATH .'demos/elementor/classiads-phone/custom-tables.php';
		}elseif($selected_import_index == 18){
			include DT_PATH .'demos/elementor/classiads-pets/terms.php';
			...
			include DT_PATH .'demos/elementor/classiads-realestate/terms.php';
			include DT_PATH .'demos/elementor/classiads-realestate/custom-tables.php';
		}else{
			include DT_PATH .'demos/terms.php';
