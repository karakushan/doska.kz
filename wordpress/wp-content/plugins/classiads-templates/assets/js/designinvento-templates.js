...
var Classiads_Templates = (function($){
    ...
    function window_loaded(){
        ...
        btn_filter_link.on( 'click', function (e) {
            ...
            var pageBuilder = $('.merlin__other-page-builder').find('.active').attr('data-group'),
                ...
                data = {
                    action: 'designinvento_template_filter_demo',
                   // wpnonce: designinvento_templates_params.wpnonce,
                    page_builder: pageBuilder,
                };

            $.ajax({ // you can also use $.post here
                url : designinvento_templates_params.ajaxurl, // AJAX handler
                data : data,
                type : 'POST',
        ...
        $('.merlin__demos').on( 'click', '.js-select-demo', function() {
            ...
            $.post( designinvento_templates_params.ajaxurl, {
                action: 'designinvento_templates_update_selected_import_data_info',
                wpnonce: designinvento_templates_params.wpnonce,
                ...
                .fail( function() { alert( designinvento_templates_params.texts.something_went_wrong ); } );
        } );
        ...
        function loadMoreDemo(page) {
            var pageBuilder = $('.merlin__other-page-builder').find('.active').attr('data-group'),
               // cat = $('.merlin__categories').find('.active').attr('data-group'),
                data = {
                    action: 'designinvento_templates_load_more_demo',
                  //  wpnonce: designinvento_templates_params.wpnonce,
                    page: page,
					page_builder: pageBuilder,
                };
    ...
    function ChildTheme() {
        ...
        function do_ajax() {
            jQuery.post(designinvento_templates_params.ajaxurl, {
                action: "designinvento_templates_child_theme",
                wpnonce: designinvento_templates_params.wpnonce,
    ...
    function ActivateLicense() {
        ...
        function do_ajax() {
            ...
            jQuery.post(designinvento_templates_params.ajaxurl, {
              action: "designinvento_templates_activate_license",
              wpnonce: designinvento_templates_params.wpnonce,
    ...
    function PluginManager(){
        ...
        function process_current(){
            if(current_item){
                ...
                if($check.is(":checked")) {
                    jQuery.post(designinvento_templates_params.ajaxurl, {
                        action: "designinvento_templates_plugins",
                        wpnonce: designinvento_templates_params.wpnonce,
                        slug: current_item,
                    }, ajax_callback).fail(ajax_callback);
                }else{
        ...
        return {
            init: function(btn){
				$(".merlin__content--plugins").addClass("installing");
                $(".merlin__drawer--install-plugins").addClass("installing");
				$(".merlin__content--plugins.installing a.merlin__button--next").addClass("merlin__button--loading");
    ...
    function ContentManager(){
        ...
        function init_content_import_progress_bar() {
            ...
            jQuery.post(designinvento_templates_params.ajaxurl, {
                action: "designinvento_templates_get_total_content_import_items",
                wpnonce: designinvento_templates_params.wpnonce,
                selected_index: getCookie('demo'),
            }, function( response ) {
        ...
        return {
            ...
            $.post(designinvento_templates_params.ajaxurl, {
                action: "designinvento_templates_import_finished",
                wpnonce: designinvento_templates_params.wpnonce,
                selected_index: getCookie('demo'),
            });
