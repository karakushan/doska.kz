...
class CPFM_Feedback_Notice {
    ...
    public function cpfm_enqueue_assets() {
        ...
        wp_enqueue_style('cpfm-common-review-style', ATLT_PRO_URL . 'admin/feedback/css/cpfm-admin-feedback.css');
        wp_enqueue_script(
            'cpfm-common-review-script', 
            ATLT_PRO_URL . 'admin/feedback/js/cpfm-admin-feedback.js', 
            ['jquery'], 
            ATLT_PRO_VERSION, 
            true
