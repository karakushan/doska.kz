    ...
    <div class="atlt-dashboard-left-section">
        ...
        <div class="atlt-dashboard-welcome">
            <div class="atlt-dashboard-welcome-text">
                ...
                <a class="atlt-dashboard-docs" href="<?php echo esc_url('https://example.com/docs/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_pro'); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo esc_url(ATLT_PRO_URL . 'admin/atlt-dashboard/images/document.svg'); ?>" alt="document"> <?php echo esc_html__('Read Plugin Docs', $text_domain); ?></a>
            </div>
            <div class="atlt-dashboard-welcome-video">
                <a href="<?php echo esc_url('https://example.com/docs/auto-translations-via-google-translate/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_video_pro'); ?>" target="_blank" rel="noopener noreferrer" class="atlt-dashboard-video-link">
            ...
            <div class="atlt-dashboard-providers-grid">
                ...
                $providers = [
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/gemini-ai-translations-wordpress/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_gemini_pro'),
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/gemini-ai-translations-wordpress/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_openai_pro'),
                        esc_url('admin.php?page=loco-atlt-dashboard&tab=settings')
                    ],
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/chatgpt-ai-translations-wordpress/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_chatgpt_pro')
                    ],
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/how-to-use-chrome-ai-auto-translations/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_chrome_pro')
                    ],
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/auto-translations-via-google-translate/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_google_pro')
                    ],
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/translate-plugin-theme-via-yandex-translate/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_yandex_pro')
                    ],
                    ...
                    [
                        ...
                        esc_url('https://example.com/docs/translate-via-deepl-doc-translator/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_deepl_pro')
                    ]
                ];
