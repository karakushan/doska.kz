<?php
/**
 * Class Loco_Automatic_Translate_Addon_Pro\AI_Translate\Google\Google_AI_API_Client
 *
 * @since 0.1.0
 * @package ai-services
 */
...
use Loco_Automatic_Translate_Addon_Pro\AI_Translate\Services\Base\Generic_AI_API_Client;
...
class Google_AI_API_Client extends Generic_AI_API_Client {
	...
	protected function add_default_options( array $request_options ): array {
		...
		$request_options['headers']['X-Goog-Api-Client'] = 'ai-services/' . ATLT_PRO_VERSION;
