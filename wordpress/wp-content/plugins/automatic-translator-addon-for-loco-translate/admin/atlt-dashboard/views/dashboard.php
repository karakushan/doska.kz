    ...
    <div class="atlt-dashboard-left-section">
        ...
        <div class="atlt-dashboard-welcome">
            <div class="atlt-dashboard-welcome-text">
                ...
                echo esc_html__('Welcome To LocoAI', $text_domain); ?></h2>
                <p><?php 
                // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
                echo esc_html__('Translate WordPress plugins or themes instantly with LocoAI. One-click, thousands of strings - no extra cost!', $text_domain); ?></p>
                <div class="atlt-dashboard-btns-row">
                    <a href="<?php 
                    // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
                    echo esc_url(admin_url('admin.php?page=loco-plugin')); ?>" class="atlt-dashboard-btn primary"><?php 
                    // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
                    echo esc_html__('Translate Plugins', $text_domain); ?></a>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=loco-theme')); ?>" class="atlt-dashboard-btn"><?php 
                    // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
                    echo esc_html__('Translate Themes', $text_domain); ?></a>
                </div>
                <a class="atlt-dashboard-docs" href="<?php 
                // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
                echo esc_url('https://locoaddon.com/docs/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard'); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo esc_url(ATLT_URL . 'admin/atlt-dashboard/images/document.svg'); ?>" alt="document"> <?php echo esc_html__('Read Plugin Docs', $text_domain); ?></a>
            </div>
        ...
        <div class="atlt-dashboard-translation-providers">
            <h3><?php
            // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
            esc_html_e('Translation Providers', $text_domain); ?></h3>
            <div class="atlt-dashboard-providers-grid">
                ...
                $atlt_providers = [
                    ...
                    ["OpenAI Translations","openai-logo.png","Free",["Unlimited Translations","Fast Translations via openAI","OpenAI API Key Required"],esc_url('https://locoaddon.com/docs/open-ai-translations-wordpress/?utm_source=atlt_plugin&utm_medium=inside&utm_campaign=docs&utm_content=dashboard_openai'),esc_url('admin.php?page=loco-atlt-dashboard&tab=settings')],
                ...
                foreach ($atlt_providers as $atlt_index => $atlt_provider) {
                    ?>
                    <div class="atlt-dashboard-provider-card">
                        <div class="atlt-dashboard-provider-header">
                            <a href="<?php echo esc_url($atlt_provider[4]); ?>" target="_blank" rel="noopener noreferrer"><img src="<?php echo esc_url(ATLT_URL . 'assets/images/' . $atlt_provider[1]); ?>" alt="<?php echo esc_attr($atlt_provider[0]); ?>"></a>
                            <span class="atlt-dashboard-badge <?php echo esc_attr( strtolower($atlt_provider[2]) ); ?>"><?php echo esc_html( $atlt_provider[2] ); ?></span>
                        </div>
                        <h4><?php echo esc_html( $atlt_provider[0] ); ?></h4>
                        <ul>
                            <?php foreach ($atlt_provider[3] as $atlt_feature) { ?>
                                <li>✅ <?php echo esc_html( $atlt_feature ); ?></li>
                            <?php } ?>
                        </ul>
                        <div class="atlt-dashboard-provider-buttons">
                            <a href="<?php 
                            // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain
                            echo esc_url($atlt_provider[4]); ?>" class="atlt-dashboard-btn" target="_blank" rel="noopener noreferrer"><?php echo esc_html__('Docs', $text_domain); ?></a>
                            <?php if (isset($atlt_provider[5])) { ?>
                                <a href="<?php echo esc_url($atlt_provider[5]); ?>" class="atlt-dashboard-btn">Settings</a>
                            <?php } ?>
                        </div>
                    </div>
                    <?php
