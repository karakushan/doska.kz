		...
		?>
			<div class="hfb-site-logo-set">           
				<div class="hfb-site-logo-container">
					<img class="hfb-site-logo-img <?php echo esc_attr( $class_animation ); ?>"  src="<?php echo esc_url( $image_url ); ?>" width="<?php echo esc_attr($image_size[0]); ?>" height="<?php echo esc_attr($image_size[1]); ?>" alt="<?php echo esc_attr( Control_Media::get_image_alt( $settings['logo'] ) ); ?>"/>
				</div>
			</div>
		<?php if ( $link ) : ?>
					</a>
