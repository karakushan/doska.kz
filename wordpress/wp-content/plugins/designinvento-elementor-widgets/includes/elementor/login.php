...
class Pacz_Elementor_Login extends Widget_Base {
	...
	public function scripts() {
			wp_register_style( 'hfb-user-menu', DEW_ASSETS_URL .'css/user-menu.css');
	...
	protected function container() {
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('Container', 'designinvento-elementor-widgets'),
            ]
        );
		$this->add_responsive_control(
            'user_menu_container_align',
            [
                'label' => esc_html__( 'Alignment', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'designinvento-elementor-widgets' ),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__( 'Center', 'designinvento-elementor-widgets' ),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => esc_html__( 'Right', 'designinvento-elementor-widgets' ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Direction', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'ltr' => [
                        'title' => esc_html__( 'Left to right', 'designinvento-elementor-widgets' ),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'rtl' => [
                        'title' => esc_html__( 'Right to left', 'designinvento-elementor-widgets' ),
                        'icon' => 'eicon-text-align-right',
                    ],
                ],
                'default' => 'left',
	...
	protected function login() {
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('Login Button', 'designinvento-elementor-widgets'),
            ]
        );
       ...
       $this->add_responsive_control(
			...
			[
				...
				'label_on' => esc_html__( 'Show', 'designinvento-elementor-widgets' ),
				'label_off' => esc_html__( 'Hide', 'designinvento-elementor-widgets' ),
				'return_value' => 'yes',
				'default' => 'yes',
			]
        );
		$this->add_responsive_control(
			'login_button_style',
			[
				'label' => esc_html__( 'Choose Style', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'both',
				'options' => [
					'icon'  => esc_html__( 'Icon', 'designinvento-elementor-widgets' ),
					'text' => esc_html__( 'Text', 'designinvento-elementor-widgets' ),
					'both' => esc_html__( 'Both', 'designinvento-elementor-widgets' ),
				],
			]
        );
        $this->add_responsive_control(
            'login_button_icon',
            [
                'label'         => esc_html__('Login Button Icon', 'designinvento-elementor-widgets'),
                'label_block'   => true,
        ...
        $this->add_responsive_control(
            'login_button_text',
            [
                'label' => esc_html__('Button Text', 'designinvento-elementor-widgets'),
                'label_block' => true,
        ...
        $this->add_responsive_control(
            'login_button_url',
            [
                'label' => esc_html__( 'Url', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::URL,
                'placeholder' => esc_html__( 'https://designsvilla.com/', 'designinvento-elementor-widgets' ),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => true,
	...
	protected function register() {
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('Register Button', 'designinvento-elementor-widgets'),
            ]
        );
       ...
       $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                'label'         => esc_html__('Register Button Icon', 'designinvento-elementor-widgets'),
                'label_block'   => true,
                'type'          => Controls_Manager::ICONS,
				'condition' => [
	...
	protected function divider() {
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('Divider', 'designinvento-elementor-widgets'),
            ]
        );
       ...
       $this->add_responsive_control(
			'button_divider',
			[
				'label' => esc_html__( 'turm on divider', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'designinvento-elementor-widgets' ),
				'label_off' => esc_html__( 'Hide', 'designinvento-elementor-widgets' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            'button_divider_icon',
            [
                'label'         => esc_html__('Icon', 'designinvento-elementor-widgets'),
                'label_block'   => true,
                'type'          => Controls_Manager::ICONS,
				'condition' => [
        ...
        $this->add_responsive_control(
            'button_divider_text',
            [
                'label' => esc_html__('Text', 'designinvento-elementor-widgets'),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => 'Or',
				'condition' => [
	...
	protected function user_menu() {
		$this->start_controls_section(
            'user_menu_section',
            [
                'label' => esc_html__('User Menu', 'designinvento-elementor-widgets'),
            ]
        );
		$this->add_responsive_control(
            'user_menu_align',
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Dropdown Items Alignment', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'designinvento-elementor-widgets' ),
		...
		$this->add_control(
			'user_profile_image',
			[
				'label' => esc_html__( 'User Profile Image', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'profile_photo',
				'options' => [
					'profile_photo'  => esc_html__( 'profile photo', 'designinvento-elementor-widgets' ),
					'custom_icon' => esc_html__( 'Custom Icon', 'designinvento-elementor-widgets' ),
					'disable' => esc_html__( 'Disable', 'designinvento-elementor-widgets' ),
				],
		...
		$this->add_control(
			'user_display_name',
			[
				'label' => esc_html__( 'User Display Name', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'designinvento-elementor-widgets' ),
				'label_off' => esc_html__( 'Hide', 'designinvento-elementor-widgets' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'user_nicename',
			[
				'label' => esc_html__( 'User Nicename', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'designinvento-elementor-widgets' ),
				'label_off' => esc_html__( 'Hide', 'designinvento-elementor-widgets' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'user_menu_dropdown',
			[
				'label' => esc_html__( 'User Menu Dropdown', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default'  => esc_html__( 'Default', 'designinvento-elementor-widgets' ),
					'custom' => esc_html__( 'Custom', 'designinvento-elementor-widgets' ),
				],
			]
        );
        ...
        $user_menu_links->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Label', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::TEXT,
                'default' => 'Dashboard',
            ]
        );
        ...
        $user_menu_links->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::URL,
                'default' => [
                    'url' => 'https://designsvilla.com/dashboard',
                ],
            ]
        );
		$user_menu_links->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Add user dropdown menu', 'designinvento-elementor-widgets'),
	...
	protected function login_styling() {
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Login Menu', 'designinvento-elementor-widgets' ),
        ...
        $this->add_responsive_control(
			'login_button_margin',
			[
				'label' => esc_html__( 'Margin', 'designinvento-elementor-widgets' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Padding', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Size', 'designinvento-elementor-widgets' ),
		...
		$this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Typography', 'designinvento-elementor-widgets' ),
		...
		// border radius
		 $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Border radius', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
				'default' => [
					'top' => '',
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Normal', 'designinvento-elementor-widgets' ),
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Text Color', 'designinvento-elementor-widgets' ),
        ...
        $this->add_responsive_control(
            'login_button_bg',
            [
                'label'     => esc_html__( 'Background Color', 'designinvento-elementor-widgets' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__( 'Hover', 'designinvento-elementor-widgets' ),
            ]
        );
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Border Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
	...
	protected function register_styling() {
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Register Menu', 'designinvento-elementor-widgets' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
	...
	protected function user_menu_styling() {
		...
		$this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Display Name Typography', 'designinvento-elementor-widgets' ),
		...
		$this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Display Nicename Typography', 'designinvento-elementor-widgets' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Display Name Text Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Nicename Text Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Box background Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Box border Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Box Size', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'em' ],
                'range' => [
                    'px' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Icon Box Margin', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		// border radius
		 $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Box Border radius', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
				'default' => [
					'top' => '',
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'icon box Padding', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
    ...
    protected function user_menu_dropdown_styling() {
		...
		$this->add_responsive_control(
            ...
            [
                'label'     => esc_html__( 'Box Background Color', 'designinvento-elementor-widgets' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label'     => esc_html__( 'Box Border Color', 'designinvento-elementor-widgets' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .hfb-user-menu .dropdown-content ul:hover' => 'background-color: {{VALUE}};',
                ],
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Menu Item Margin', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Menu Item Padding', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em' ],
				'selectors' => [
		...
		$this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Links Typography', 'designinvento-elementor-widgets' ),
		...
		// border radius
		 $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Menu Item Border radius', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
				'default' => [
					'top' => '',
		...
		$this->add_responsive_control(
            ...
            [
                'label'     => esc_html__( 'Menu Item Background Color', 'designinvento-elementor-widgets' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Links Text Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label'     => esc_html__( 'Menu Item Border Color', 'designinvento-elementor-widgets' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .hfb-user-menu .dropdown-content ul li a:hover' => 'background-color: {{VALUE}};',
                ],
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Icon Margin', 'designinvento-elementor-widgets' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Links Icon Color', 'designinvento-elementor-widgets' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
	...
	//var_dump($settings['user_profile_image']);
		...
		$user_dropdown_menu_direction = (isset($settings['user_dropdown_menu_direction']))? $settings['user_dropdown_menu_direction']: '';
				...
				if(class_exists('Directorypress_Frontend') && class_exists('DirectoryPress')){
					echo '<div class="dropdown">';
						echo '<button class="dropbtn">';
							...
							echo '</div>';
						echo '</button>';
						echo '<div class="dropdown-content '. esc_attr($user_dropdown_menu_direction) .'">';
							echo '<ul class="clearfix">';
								if($settings['user_menu_dropdown'] == 'custom'){
									$this->custom_user_menu_links();
								}else{
									echo '<li><a href="'. directorypress_dashboardUrl().'"><i class="fas fa-tachometer-alt"></i>'. esc_html__('My Dashboard', 'designinvento-elementor-widgets') .'</a></li>';
									echo '<li><a href="'. directorypress_dashboardUrl().'"><i class="fas fa-ad"></i>'. esc_html__('My Listings', 'designinvento-elementor-widgets') .'</a></li>';
									echo '<li><a href="'. directorypress_dashboardUrl(array('directory_action' => 'profile')) .'"><i class="fas fa-user"></i>'. esc_html__('Edit Profile', 'designinvento-elementor-widgets') .'</a></li>';
									echo '<li><a href="'. wp_logout_url(esc_url( home_url('/'))) .'"><i class="fas fa-sign-out-alt"></i>'. esc_html__('logout', 'designinvento-elementor-widgets') .'</a></li>';
								}
							echo '</ul>';
						echo '</div>';
					echo '</div>'; 
				}else{
					echo '<a class="hfb-logout-menu clearfix" href="'.wp_logout_url(esc_url( home_url('/'))).'">'.esc_html__('logout', 'designinvento-elementor-widgets').'</a>';
				} 
			}else{
				$this->login_button();
				$this->button_divider();
